...
class SimpleCommand implements Command
{
    ...
    public function execute(): void
    {
        echo "ПростаяКоманда: Смотри, я могу печатать простые команды, например: (" . $this->payload . ")<br>";
    }
}
...
class ComplexCommand implements Command
{
    ...
    public function execute(): void
    {
        echo "СложнаяКоманда: Сложные операции должны выполняться объектом-получателем.<br>";
...
class Receiver
{
    ...
    {
        echo "Получатель: Работаю над (" . $a . ".)<br>";
    }

    public function doSomethingElse(string $b): void
    {
        echo "Получатель: Также работаю над (" . $b . ".)<br>";
    }
}
...
class Invoker
{
    ...
    {
        echo "Отправитель: Кто-нибудь хочет что-нибудь сделать перед тем, как я начну?<br>";
        if ($this->onStart instanceof Command) {
            $this->onStart->execute();
        }

        echo "Отправитель: ...делает что-то очень важное...<br>";

        echo "Отправитель: Кто-нибудь хочет что-нибудь сделать после того, как я закончу?<br>";
...
$invoker->setOnFinish(new ComplexCommand($receiver, "Отправить сообщение", "Сохранить отчет"));

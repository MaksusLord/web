...
class ConcreteProduct1 implements Product
{
    public function operation(): string
    {
        return "{Результат КонкретногоПродукта1}<br>";
    }
}
...
class ConcreteProduct2 implements Product
{
    public function operation(): string
    {
        return "{Результат КонкретногоПродукта2}<br>";
    }
}
...
{
    // ...
    echo "Клиент: Я не знаю, какой конкретно создатель, но он все равно работает.. <br>"
 ...
 * среды.
 */
echo "Приложение: Запущено с КонкретныйСоздатель1. <br>";
clientCode(new ConcreteCreator1());
#echo "\n\n";

echo "Приложение: Запущено с КонкретныйСоздатель2. <br>";

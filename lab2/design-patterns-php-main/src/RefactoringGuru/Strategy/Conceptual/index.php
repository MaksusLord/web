...
class Context
{
    ...
    public function doSomeBusinessLogic(): void
    {
        ...
        echo "Контекст: Сортировка данных с использованием стратегии (не зная её конкретной реализации)<br>";
...
echo "Клиент: Установлена стратегия обычной сортировки.<br>";
$context->doSomeBusinessLogic();

echo "\n";

echo "Клиент: Установлена стратегия обратной сортировки.<br>";

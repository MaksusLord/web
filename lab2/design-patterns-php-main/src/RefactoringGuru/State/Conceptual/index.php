...
class ConcreteStateA extends State
{
    ...
    {
        echo "КонкретноеСостояниеA обрабатывает запрос1.<br>";
        echo "КонкретноеСостояниеA хочет изменить состояние контекста.<br>";
        $this->context->transitionTo(new ConcreteStateB());
    }

    public function handle2(): void
    {
        echo "КонкретноеСостояниеA обрабатывает запрос2.<br>";
    }
}
...
class ConcreteStateB extends State
{
    public function handle1(): void
    {
        echo "КонкретноеСостояниеB обрабатывает запрос1.<br>";
    }

    public function handle2(): void
    {
        echo "КонкретноеСостояниеB обрабатывает запрос2.<br>";
        echo "КонкретноеСостояниеB хочет изменить состояние контекста.<br>";

...
abstract class AbstractClass
{
    ...
    {
        echo "АбстрактныйКласс сообщил: Я выполняю основную часть работы<br>";
    }

    protected function baseOperation2(): void
    {
        echo "АбстрактныйКласс сообщил: Но я позволяю подклассам переобпределять некоторую часть работы<br>";
    }

    protected function baseOperation3(): void
    {
        echo "АбстрактныйКласс сообщил: Но основную работу все равно выполняю я <br>";
    }
...
class ConcreteClass1 extends AbstractClass
{
    ...
    {
        echo "КонкретныйКласс1 сообщил: Реализация операции1<br>";
    }

    protected function requiredOperation2(): void
    {
        echo "КонкретныйКласс1 сообщил: Реализация операции2<br>";
    }
}
...
class ConcreteClass2 extends AbstractClass
{
    protected function requiredOperations1(): void
    {
        echo "КонкретныйКласс2 сообщил: Реализация операции1<br>";
    }

    protected function requiredOperation2(): void
    {
        echo "КонкретныйКласс2 сообщил: Реализация операции2<br>";
    }

    protected function hook1(): void
    {
        echo "КонкретныйКласс2 сообщил: Переопределеный Хук1<br>";
    }
}

...
class Flyweight
{
    ...
    public function operation($uniqueState): void
    {
        ...
        echo "Легковес: Отображение внешнего ($s) и уникального ($u) состояния.\n";
    }
}
...
class FlyweightFactory
{
    ...
    public function listFlyweights(): void
    {
        ...
        echo "<br>Фабрика Легковесов: У меня есть $count легковесов:<br>";
...
function addCarToPoliceDatabase(
    ...
    echo "<br>Клиент: Добавляю автомобиль в базу данных..<br>";
